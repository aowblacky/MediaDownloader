    ...
    <Grid Margin="16">
        ...
        <Grid Grid.Row="0" Margin="0,0,0,10">
            ...
            <StackPanel Grid.Column="1" Orientation="Horizontal" VerticalAlignment="Center">
                ...
                <Button x:Name="BtnUpdateCheck" Content="&#x27F3; Updates pr&#xFC;fen" Style="{StaticResource ModernBtn}" Padding="10,5" FontSize="11" ToolTip="Pr&#xFC;ft auf Updates f&#xFC;r Media Downloader &amp; Tools"/>
            </StackPanel>
        </Grid>
        ...
        <Grid Grid.Row="4" Margin="0,4,0,0">
            ...
            <TextBlock x:Name="TxtFooter" Grid.Column="0" Text="Media Downloader &#x2022; Bereit" VerticalAlignment="Center" FontSize="12" Foreground="#6C7086"/>
...
function Check-Updates([bool]$silentIfCurrent = $false) {
    $TxtFooter.Text = "Prüfe auf Updates..."
    ...
    try {
        ...
        if ($remoteVer -gt $currentVer) {
            $msg = "Eine neue Version von Media Downloader ist verfuegbar!`n`nAktuelle Version: v$AppVersion`nNeueste Version:  v$($remoteMeta.version)`n`nChangelog:`n$($remoteMeta.changelog)`n`nMoechtest du das Update jetzt herunterladen und anwenden?"
            $res = [System.Windows.MessageBox]::Show($msg, "App-Update verfuegbar", [System.Windows.MessageBoxButton]::YesNo, [System.Windows.MessageBoxImage]::Information)

            if ($res -eq [System.Windows.MessageBoxResult]::Yes) {
                $TxtFooter.Text = "Lade Update herunter..."
                ...
                if ((Test-Path $tempFile) -and (Get-Item $tempFile).Length -gt 5000) {
                    ...
                    [System.Windows.MessageBox]::Show("Update erfolgreich installiert! Die App wird jetzt neu gestartet.", "Update fertig", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Information)
            ...
            if (-not $silentIfCurrent) {
                [System.Windows.MessageBox]::Show("Media Downloader und alle Tools sind auf dem neuesten Stand! (v$AppVersion)", "Kein Update noetig", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Information)
            }
        }
    } catch {
        if (-not $silentIfCurrent) {
            [System.Windows.MessageBox]::Show("yt-dlp und FFmpeg werden im Hintergrund aktualisiert.`n(GitHub Repository Pruefung: $($_.Exception.Message))", "Tools aktualisiert", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Information)
        }
    }

    $TxtFooter.Text = "Media Downloader • Bereit"
}
